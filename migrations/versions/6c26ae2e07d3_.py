...
Revision ID: 6c26ae2e07d3
Revises: 
Create Date: 2023-12-11 14:01:31.394063
...
def upgrade():
    ...
    sa.Column('armor_inventory', sa.PickleType(), nullable=True),
    sa.Column('weapon_inventory', sa.PickleType(), nullable=True),
